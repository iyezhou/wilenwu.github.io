...
- :ballot_box_with_check:   [微积分 I][c1]：一元函数微积分
- :ballot_box_with_check:   [微积分 II][c2]：多元函数微积分，曲线积分和曲面积分
- :ballot_box_with_check:   [微积分 III][c3]：无穷级数 
...
- :ballot_box_with_check:   [线性代数][Linear Algebra] ：矩阵，行列式，向量空间，二次型，线性变换
- :ballot_box_with_check:   [常微分方程][ode]
- :ballot_box_with_check:   [偏微分方程][pde]：(数学物理方程)
- :ballot_box_with_check:   [群论基础][Group Theory]  
- :ballot_box_with_check:   [近世代数][Modern Algebra] ：(抽象代数)群、环、域  
- :ballot_box_with_check:   [微分几何][Differential Geometry]
- :white_large_square:  [高等几何][High Geometry]
- :heart:  拓扑学   
...
[Modern Algebra]: https://blog.csdn.net/qq_41518277/article/details/92605711
[Differential Geometry]: https://blog.csdn.net/qq_41518277/article/details/92606394
[High Geometry]: https://blog.csdn.net/qq_41518277/article/details/92614884

## <font color="green">书籍清单</font> 

- 高等数学：(数学分析)微积分，无穷级数，常微分方程，空间解析几何
- 数学物理方法：复变函数，积分变换，偏微分方程
- 概率论与数理统计
- 线性代数
- 近世代数
...
- :ballot_box_with_check:   电动力学：电磁理论，狭义相对论
...
- :ballot_box_with_check:   量子场论：QED,QCD等
